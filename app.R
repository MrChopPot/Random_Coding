...
# Thanks to Dr. Sung Pil Moon from Indiana University
###############################################################################
...
header <- dashboardHeader(
  title = tags$strong("Salary Comparator")
)
...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem("Visit Me", icon = icon("send", lib='glyphicon'), href = "https://github.com/MrChopPot")
  )
) 
...
body <- dashboardBody(
  ...
  tabItems(
                ...
                column(12, 
                  tags$div(
                    ...
                    tags$span(tags$strong("U.S. Salary Comparator,"), 
                      ...
                      tags$li("Attorney"), 
                      tags$li("Teacher"),
                      tags$mark(tags$i("* Please note that the data is from the United States Department of Labor, Employment & Training Administration 
                             and based on the prevailing wage data of foreign employers (The prevailing wage data of US natives are not included)")),
                      tags$br()
                    )
                  ),
                  br()
                ...
                column(12, 
                       tags$div(
                         ...
                         tags$span(
                          ...
                          tags$li("Source: ",tags$a(href = "https://www.foreignlaborcert.doleta.gov/performancedata.cfm", "Performance Data")),
                ...
                column(12, 
                       tags$div(
                         ...
                         tags$span(
                           ...
                           "who are current Business Analytics master students at Carey Business School, Johns Hopkins University.")  
                       ),
                       tags$img(src="carey.jpg", height=100, width=300),
                       tags$li("If you have any suggestion, question, or reviews for this app, comments are open! 
                       Please send an email to ", tags$a(href = "mailto: conradkang@jhu.edu", "conradkang@jhu.edu"), "and reference this Shiny app.")
                )
                ),
                br()
              )
    ...
    tabItem("myTabForExternalInfo",
            ...
            fluidRow(
              box(
                title = "Top Recruiter rank (by Data Science)", solidHeader = TRUE,
                tags$div(
                  "Source from ",
                  tags$span(      
