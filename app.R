           ...
           fluidRow(
              column(4, 
                     selectizeInput('singleSelectForStatesForScatterPlot', 'States:', 
                                    c("All"= 'All', structure(state.abb, names=state.name), "Washington, DC" = "DC"),
                                    multiple = F)
                     ),
              column(4, 
            ...
            fluidRow(
              ...
              column(4,
                     selectizeInput('multiSelectForStates', 'States:', 
                                    c("Choose multiple"= '', structure(state.abb, names=state.name), "Washington, DC" = "DC"),
                                    multiple = TRUE
                     )
              ),
            ...
            fluidRow(
                ...
                column(4, 
                       selectizeInput('singleSelectForStates', 'States:', 
                                      c("All", structure(state.name, names=state.name), "Washington, DC" = "District of Columbia"),
                                      multiple = F)
                ),
